...
class AutofillInlineMenuList extends AutofillInlineMenuPageElement {
    ...
    initAutofillInlineMenuList(message) {
        return autofill_inline_menu_list_awaiter(this, void 0, void 0, function* () {
            const { translations, styleSheetUrl, theme, authStatus, ciphers = [], portKey, inlineMenuFillType = CipherType.Login, showInlineMenuAccountCreation = false, showPasskeysLabels = false, generatedPassword, showSaveLoginMenu, } = message;
